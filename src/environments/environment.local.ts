export const environment = {
    production: false,
    cruiseCodeApiBaseUrl: 'https://apidev.cruisecode.com/',
    ...
    resetUserPasswordLink:
        'https://cruisecode.b2clogin.com/cruisecode.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_ResetPassword&client_id=0471f107-0166-4098-a546-40f9ec89f5fe&nonce=defaultNonce&redirect_uri=http%3A%2F%2Flocalhost%3A4200%2Fsign-in-redirect&scope=openid%20profile%20offline_access&response_mode=fragment&response_type=code&x-client-SKU=msal.js.browser&x-client-VER=2.32.1&client_info=1&code_challenge=CEuP4RsX0EkotfjvcPRqiG-RFIQmsK04VbvecH3LwyQ&code_challenge_method=S256&nonce=a9dd2070-2164-48ae-89cd-c0229f41205c&state=eyJpZCI6IjQyYjcyM2ViLWM5NDEtNDBmMi04MTlhLTc5NmViZGFmMDExOSIsIm1ldGEiOnsiaW50ZXJhY3Rpb25UeXBlIjoicmVkaXJlY3QifX0%3D',
