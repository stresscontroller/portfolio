...
import { TourInventoryState } from '../../state';
...
export class CalendarControlsComponent {
    ...
    calendarControlsForm = new FormGroup({
        ...
        type: new FormControl<'ALL' | 'A' | 'UA' | 'R'>('R'),
    });
    ...
    appliedFilters$ = this.tourInventoryState.manageAllocationInventories$.pipe(
    ...
    onSubmit(): void {
        ...
        this.tourInventoryState.searchAllocations({
            searchType: 'R',
